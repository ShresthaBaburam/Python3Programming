...
class ManageProduct:
    ...
    #table for tha detail view of the propduct
        ...
        self.trv['columns']=('Id','Product','Stocks','CostPrice','vender','phone','Mfd.Date','Exp.Date','Max.Ret.Price','MarkedPrice','remarks')
        ...
        self.trv.column('Product',width=120,minwidth=100,anchor=tk.CENTER)
        ...
        self.trv.column('vender',width=80,minwidth=70,anchor=tk.CENTER)
        self.trv.column('phone',width=80,minwidth=70,anchor=tk.CENTER)
        ...
        self.trv.column('Max.Ret.Price',width=70,minwidth=60,anchor=tk.CENTER)
        self.trv.column('MarkedPrice',width=70,minwidth=60,anchor=tk.CENTER)
        ...
        self.trv.heading('phone',text='Vender Phone',anchor=tk.CENTER)
...
root = Tk()
manageProduct = ManageProduct(root)
